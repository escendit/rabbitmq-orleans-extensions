...
public static class ClientBuilderExtensions
{
    ...
    public static IRabbitMqClientOptionsBuilder UseStreamProtocol(this IRabbitMqClientProtocolBuilder clientBuilder, Action<ConnectionOptions> configureOptions)
    {
